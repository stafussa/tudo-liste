// Função responsável por adicionar item pelo evento de onkeypress no input// Função responsável por adicionar item pelo evento de onkeypress no input
...
function adicionarItem() {
  ...
  var valorInputed = document.getElementById("input-tarefa").value;
  ...
  criarTagLI.innerHTML = valorInputed + tagRemover;
...
function concluirTarefa(event) {
  ...
  // Aplicando uma classe para marcar a tarefa como concluída
  minhaTagLi.classList.toggle("concluida");
}

// Adicionando evento de keypress ao input
document.getElementById("input-tarefa").addEventListener("keypress", adicionarItemPelaTecla);
